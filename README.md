...
- [Gradus.jl: spacetime-agnostic general relativistic ray-tracing for X-ray spectral modelling](https://ui.adsabs.harvard.edu/abs/2025MNRAS.tmp.1668B/abstract) (2025) by Baker and Young. This paper describes the relativistic ray tracing model [Gradus.jl](https://codeberg.org/astro-group/Gradus.jl) that we will use to perform the calculations we need.
