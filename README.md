...
- In the [Gradus paper](https://ui.adsabs.harvard.edu/abs/2026MNRAS.545f1770B/abstract) the routine [`reverberation.lag-energy.jl`](https://github.com/fjebaker/gradus-paper/blob/main/code/reverberation.lag-energy.jl) is used to calculate the lag-energy spectrum shown in Figure 13.
